			...
			<tbody>
				...
				<tr class="dot_line">
	                ...
	                <td>
	                    ...
	                    - <input class="pl-3" type="text" size=4  name="tel2" value="${memberInfo.tel2 }">
	                    - <input class="pl-3" type="text" size=4  name="tel3" value="${memberInfo.tel3 }">
	                </td>
	                <td>
				...
				<tr class="dot_line">
					...
					<td>
					 ...
					 - <input class="pl-3" type="text" name="hp2" size=4 value="${memberInfo.hp2 }">
					 - <input class="pl-3" type="text"name="hp3"  size=4 value="${memberInfo.hp3 }"><br> <br>
					 <c:choose>
				...
				<tr class="dot_line">
					...
					<td>
					   <input class="pl-3" type="text" name="email1" size=10 value="${memberInfo.email1 }" /> @ <input class="pl-3" type="text" size=10  name="email2" value="${memberInfo.email2 }" />
				...
				<tr class="dot_line">
					...
					<td>
					   <input class="pl-3 mb-3" type="text" id="zipcode" name="zipcode" size=5 value="${memberInfo.zipcode }" > <a href="javascript:execDaumPostcode()">우편번호검색</a>
					  <br>
					  <p>
