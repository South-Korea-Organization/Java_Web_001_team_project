...
<c:when test="${side_menu=='admin_mode' }">
   <li>
		...
		<ul>
			...
			<li><a href="#">배송관리</a></li>
			<li><a href="${contextPath}/admin/goods/adminBoardMain.do">게시판관리</a></li>
		</ul>
	</li>
</c:when>
<c:when test="${side_menu=='my_page' }">
	<li>
		...
		<ul>
			...
			<li><a href="${contextPath}/mypage/listChangeMyOrderStatus.do">반품/교환 신청 및 조회</a></li>
	...
	<li>
		...
		<!-- 마이페이지 추가 -->
			...
			<li><a href="${contextPath}/mypage/myAddressPage.do">나의 주소록</a></li>
			<li><a href="${contextPath}/mypage/myWithDrawal.do">회원탈퇴</a></li>
		</ul>
	</li>
</c:when>
<c:otherwise>
